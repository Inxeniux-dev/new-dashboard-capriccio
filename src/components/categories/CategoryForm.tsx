...
import type { Category } from '@/services/categorizationService';
import type { CreateCategoryData, UpdateCategoryData } from '@/services/categoryAdminService';
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          placeholder="Productos donde el chocolate es el sabor principal"
          disabled={saving}
        />
      </div>
